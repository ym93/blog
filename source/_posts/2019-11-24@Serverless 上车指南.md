...
{% img no-border /img/posts/2019/11/serverless_intro.jpg 540 Serverless %}
...
{% img no-border /img/posts/2019/11/serverless_pizza_as_a_service.jpg 540 Serverless Framework %}
...
{% img no-border /img/posts/2019/11/serverless_faas.jpg 540 FaaS %}
...
{% img no-border /img/posts/2019/11/serverless_serverless_framework.jpg 540 Serverless Framework %}
...
{% img /img/posts/2019/11/serverless_practice.jpg 320 Talk is cheap %}
...
{% img /img/posts/2019/11/serverless_scf_trigger.jpg 480 云函数触发器 %}
...
{% img /img/posts/2019/11/serverless_serverless_framework_deploy.jpg 540 Serverless Framework 部署 %}
...
{% img no-border /img/posts/2019/11/serverless_openwhisk.jpg 540 OpenWhisk %}       
...
{% img no-border /img/posts/2019/11/serverless_openwhisk_principle.jpg 450 OpenWhisk 工作原理 %} 
